...
public class MyAtomicIntegerArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("classloader: " + Unsafe.class.getClassLoader());
        System.out.println("classloader: " + MyAtomicIntegerArray.class.getClassLoader());
        int[] arr = new int[1024];
        MyAtomicIntegerArray atomicIntArray = new MyAtomicIntegerArray(arr);
        System.out.println(base);
        System.out.println(shift);
        System.out.println(byteOffset(512));
    }
