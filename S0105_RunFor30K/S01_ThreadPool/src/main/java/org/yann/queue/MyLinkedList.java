        ...
        implements List<E>, Deque<E>, Cloneable, java.io.Serializable
{
    ...
    private void linkFirst(E e) {
        ...
        final Node<E> newNode = new Node<E>(null, e, oldFirst);
        first = newNode;
        if (oldFirst == null) {
            last = newNode;
        } else {
    ...
    void linkLast(E e) {
        ...
        final Node<E> newNode = new Node<E>(oldLast, e, null);
        last = newNode;
        if (oldLast == null) {
            first = newNode;
        } else {
    ...
    private static final long serialVersionUID = 888888888888888888L;
